...
main ()
{
  ...
  gpg_key_url="https://packagecloud.io/Computology/packagecloud-test-packages/gpgkey"
  apt_config_url="https://packagecloud.io/install/repositories/Computology/packagecloud-test-packages/config_file.list?os=${os}&dist=${dist}&source=script"

  apt_source_path="/etc/apt/sources.list.d/Computology_packagecloud-test-packages.list"
  apt_keyrings_dir="/etc/apt/keyrings"
  if [ ! -d "$apt_keyrings_dir" ]; then
    mkdir -p "$apt_keyrings_dir"
  fi
  gpg_keyring_path="$apt_keyrings_dir/Computology_packagecloud-test-packages-archive-keyring.gpg"
  gpg_key_path_old="/etc/apt/trusted.gpg.d/Computology_packagecloud-test-packages.gpg"
